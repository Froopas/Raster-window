...
public:
	...
	void Render(ID3D11DeviceContext* context, ID3D11Buffer* primitiveConstantBuffer);

	void OnGround(bool ground);
	bool OnGround();

	void Mesh(MeshObject* mesh);

	void NormalMaterial(Material* material);
...
__forceinline void GameObject::NormalMaterial(Material* material)
{
